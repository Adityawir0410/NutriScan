// Tambahkan ini di level paling atas file
...
dependencies {
    ...
    // 3. Coil (Untuk menampilkan gambar hasil foto)
    ...
    implementation("androidx.hilt:hilt-navigation-compose:1.2.0") // Untuk ViewModel
}